...
if [ -n "$NEXT_PUBLIC_SUPABASE_URL" ] && [ -n "$NEXT_PUBLIC_SUPABASE_ANON_KEY" ]; then
    ...
    find /app/.next /app/server.js -type f -name "*.js" -exec sed -i "s|NEXT_PUBLIC_SUPABASE_URL_PLACEHOLDER|${NEXT_PUBLIC_SUPABASE_URL}|g" {} +
    find /app/.next /app/server.js -type f -name "*.js" -exec sed -i "s|NEXT_PUBLIC_SUPABASE_ANON_KEY_PLACEHOLDER|${NEXT_PUBLIC_SUPABASE_ANON_KEY}|g" {} +
else
