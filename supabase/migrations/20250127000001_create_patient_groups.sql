...
INSERT INTO public.patient_groups (name, description, color) VALUES
    ('ทั่วไป', 'กลุ่มผู้ใช้บริการทั่วไป', '#6B7280'),
    ('ฉุกเฉิน', 'กลุ่มผู้ใช้บริการฉุกเฉิน ต้องให้ความสำคัญเป็นพิเศษ', '#EF4444'),
    ('ติดตามพิเศษ', 'กลุ่มผู้ใช้บริการที่ต้องติดตามอาการเป็นพิเศษ', '#F59E0B'),
    ('ผู้สูงอายุ', 'กลุ่มผู้ใช้บริการสูงอายุที่ต้องการการดูแลเป็นพิเศษ', '#8B5CF6'),
    ('เด็กและเยาวชน', 'กลุ่มผู้ใช้บริการเด็กและเยาวชน', '#10B981'),
    ('ฟื้นฟู', 'กลุ่มผู้ใช้บริการที่อยู่ในระยะฟื้นฟูสภาพ', '#06B6D4'),
    ('เตรียมจำหน่าย', 'กลุ่มผู้ใช้บริการที่เตรียมจำหน่ายออกจากสถานพยาบาล', '#84CC16')
